...
/**
 * Provides the local service interface for FitnessRecord. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sten Martinez
 * @see FitnessRecordLocalServiceUtil
...
public interface FitnessRecordLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FitnessRecordLocalServiceUtil} to access the fitness record local service. Add custom service methods to {@link foundation.fitness.portal.service.service.impl.FitnessRecordLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FitnessRecord fetchFitnessRecordByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FitnessRecord getFitnessRecordByUuidAndGroupId(
